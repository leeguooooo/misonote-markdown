        ...
        <div className="flex items-center justify-between h-16 px-4">
          ...
          <div className="flex-1 max-w-md mx-4">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-500 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
            >
